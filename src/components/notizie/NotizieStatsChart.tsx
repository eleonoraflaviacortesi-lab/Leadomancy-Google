          ...
          >
            ...
            <div className="flex items-center justify-between p-8 border-b border-[var(--border-light)] shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="font-outfit font-bold text-[20px] text-[var(--text-primary)] tracking-[-0.5px]">Statistiche Notizie</h2>
              ...
              <div className="space-y-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-outfit font-bold text-[12px] uppercase tracking-widest text-[var(--text-muted)]">Distribuzione per Stato</h3>
                  </div>
                  <div className="w-full bg-[var(--bg-subtle)] rounded-[20px] p-6 border border-[var(--border-light)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-2">
                      <div className="w-1.5 h-4 bg-[#1A1A18] rounded-full" />
                      <h3 className="font-outfit font-bold text-[12px] uppercase tracking-widest text-[var(--text-muted)]">Notizie per Tipologia</h3>
                    </div>
                    <div className="w-full bg-[var(--bg-subtle)] rounded-[20px] p-6 border border-[var(--border-light)]">
                      <ResponsiveContainer width="100%" height={280}>
                        <PieChart>
                          ...
                          <Legend 
                            ...
                            align="center"
                            iconType="circle"
                            wrapperStyle={{ fontSize: '10px', fontFamily: 'Outfit', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', paddingTop: '24px' }}
                          />
                        </PieChart>
                      </ResponsiveContainer>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-2">
                      <div className="w-1.5 h-4 bg-[#1A1A18] rounded-full" />
                      <h3 className="font-outfit font-bold text-[12px] uppercase tracking-widest text-[var(--text-muted)]">Trend Acquisizioni</h3>
                    </div>
                    <div className="w-full bg-[var(--bg-subtle)] rounded-[20px] p-6 border border-[var(--border-light)]">
                      <ResponsiveContainer width="100%" height={280}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[28px] font-outfit font-bold text-[var(--text-primary)] leading-none">{notizie.length}</span>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[28px] font-outfit font-bold text-[var(--text-primary)] leading-none">
                ...
                <button 
                  onClick={onClose}
                  className="px-10 h-12 bg-[#1A1A18] text-white rounded-full font-outfit font-bold text-[12px] uppercase tracking-[0.15em] hover:bg-black transition-all shadow-lg shadow-black/10 active:scale-[0.98]"
                >
                  CHIUDI
                </button>
              </div>
